...
#TODO: temp data that will be pulled from database
socialPosts = [
    {
...
events = [
    ...
    {
        "name": "User created Birdwatching 101",
    ...
    {
        "name": "User created Falconry Experience",
